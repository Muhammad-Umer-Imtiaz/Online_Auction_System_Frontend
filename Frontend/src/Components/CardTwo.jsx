...
const CardTwo = ({ imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  // ✅ Fix: display first image from array or string
  const imageUrl =
        ...
        <div className="px-2 pt-4 pb-2">
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <button
              ...
              className="bg-sky-400 text-center text-white text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-sky-700 disabled:opacity-50"
            >
              Republish Auction
            </button>
          </div>
